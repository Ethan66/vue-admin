  ...
  <div class="substance">
    ...
    <table-module
      ...
      <div class="btn-content" slot="btn">
        ...
        <el-button @click="handleAdd" v-if="chooseDataArr.length < 1 && $getBtnName('visit-ip-add-ip')">{{$getBtnName('visit-ip-add-ip')}}</el-button>
        <el-button @click="handleBatchOpen" v-if="chooseDataArr.length > 0 && $getBtnName('visit-ip-open-batch')">{{$getBtnName('visit-ip-open-batch')}}</el-button>
        <el-button @click="handleBatchStop" v-if="chooseDataArr.length > 0 && $getBtnName('visit-ip-stop-batch')">{{$getBtnName('visit-ip-stop-batch')}}</el-button>
      </div>
    </table-module>
    <dialog-module
      ref="dialog"
