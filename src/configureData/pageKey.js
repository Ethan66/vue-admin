const config = {
  'version_3.0.0': {
    ...
    'tybe': [
      ...
      // 登陆日志
      // { pageCode: 'log-login1', fieldName: '姓名', fieldValue: 'userName', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // { pageCode: 'log-login1', fieldName: '部门', fieldValue: 'departmentName', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // { pageCode: 'log-login1', fieldName: '终端', fieldValue: 'terminalType', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // { pageCode: 'log-login1', fieldName: '操作系统', fieldValue: 'operateSystem', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // { pageCode: 'log-login1', fieldName: 'IP', fieldValue: 'loginIp', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // { pageCode: 'log-login1', fieldName: '状态', fieldValue: 'loginStatus', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // { pageCode: 'log-login1', fieldName: '操作信息', fieldValue: 'remark', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // { pageCode: 'log-login1', fieldName: '登录时间', fieldValue: 'gmtCreate', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // // 异常日志
      ...
      // { pageCode: 'visit-manage1', fieldName: '描述', fieldValue: 'remark', fieldRequired: 1, displayStatus: 0, setStatus: 0 },
      // { pageCode: 'visit-manage1', fieldName: '创建时间', fieldValue: 'gmtCreate', fieldRequired: 1, displayStatus: 0, setStatus: 0 }
      // { "pageCode": "staff-manage1", "fieldName": "账户", "fieldValue": "userName", "fieldRequired": 1, "displayStatus": 0, "setStatus": 1 }, { "pageCode": "staff-manage1", "fieldName": "姓名", "fieldValue": "realName", "fieldRequired": 1, "displayStatus": 0, "setStatus": 1 }, { "pageCode": "staff-manage1", "fieldName": "手机号", "fieldValue": "telephone", "fieldRequired": 1, "displayStatus": 0, "setStatus": 1 }, { "pageCode": "staff-manage1", "fieldName": "部门名称", "fieldValue": "departmentName", "fieldRequired": 1, "displayStatus": 0, "setStatus": 1 }, { "pageCode": "staff-manage1", "fieldName": "职位", "fieldValue": "position", "fieldRequired": 1, "displayStatus": 0, "setStatus": 4 }, { "pageCode": "staff-manage1", "fieldName": "汇报对象", "fieldValue": "reportToName", "fieldRequired": 1, "displayStatus": 0, "setStatus": 1 }, { "pageCode": "staff-manage1", "fieldName": "状态", "fieldValue": "statusMsg", "fieldRequired": 1, "displayStatus": 0, "setStatus": 1 }, { "pageCode": "staff-manage1", "fieldName": "状态", "fieldValue": "status", "fieldRequired": 1, "displayStatus": 1, "setStatus": 1 }, { "pageCode": "staff-manage1", "fieldName": "角色", "fieldValue": "roleName", "fieldRequired": 1, "displayStatus": 0, "setStatus": 1 },
      // {"pageCode":"function-limit1","fieldName":"姓名","fieldValue":"realName","fieldRequired":1,"displayStatus":0,"setStatus":1},{"pageCode":"function-limit1","fieldName":"手机号","fieldValue":"telephone","fieldRequired":1,"displayStatus":0,"setStatus":1},{"pageCode":"function-limit1","fieldName":"部门","fieldValue":"departmentName","fieldRequired":1,"displayStatus":0,"setStatus":1},{"pageCode":"function-limit1","fieldName":"职位","fieldValue":"position","fieldRequired":1,"displayStatus":0,"setStatus":4},{"pageCode":"function-limit1","fieldName":"角色","fieldValue":"roleName","fieldRequired":1,"displayStatus":0,"setStatus":1}
    ]
  }
}
