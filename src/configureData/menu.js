const config = {
  'version_3.0.0': {
    ...
    btn: [
      ...
      // 功能权限管理
      { menuName: '删除', menuParentName: '功能权限管理', code: 'config-batch-delete', menuUrl: '/pilianganniu1-1', sortNo: 1 }
      // // 菜单管理
      ...
      // { menuName: '新建员工', menuParentName: '员工管理', code: 'staff-manage', menuUrl: '/pilianganniu1-1', sortNo: 1 },
      // { menuName: '编辑', menuParentName: '员工管理', code: 'staff-admin-edit', menuUrl: '/pilianganniu1-1', sortNo: 1 },
      // { menuName: '停用', menuParentName: '员工管理', code: 'staff-admin-stop', menuUrl: '/pilianganniu1-1', sortNo: 1 },
      // { menuName: '启用', menuParentName: '员工管理', code: 'staff-admin-open', menuUrl: '/pilianganniu1-1', sortNo: 1 },
      // { menuName: '禁止登陆', menuParentName: '员工管理', code: 'staff-admin-nologin', menuUrl: '/pilianganniu1-1', sortNo: 1 },
      // { menuName: '允许登录', menuParentName: '员工管理', code: 'staff-admin-login', menuUrl: '/pilianganniu1-1', sortNo: 1 },
      // { menuName: '重置密码', menuParentName: '员工管理', code: 'staff-admin-reset', menuUrl: '/pilianganniu1-1', sortNo: 1 },
      // { menuName: '编辑', menuParentName: '功能权限管理', code: 'config-manage-edit', menuUrl: '/pilianganniu1-1', sortNo: 1 },
      // { menuName: '删除', menuParentName: '功能权限管理', code: 'config-manage-delete', menuUrl: '/pilianganniu1-1', sortNo: 1 },
    ]
  }
}
