...
export const menu = {
  data () {
    return this.$setBtnConfig(JSON.parse(JSON.stringify(initData)), ['edit', 'delete', { setting: { name: '按钮管理', clickFn: 'handleBtnManage' } }])
  },
  created () {
    ...
    /* // 对话框配置
    this.dialogItem = [
      { parentMenuName: '父菜单名称', type: 'select', options: [], placeholder: '父菜单名称' },
